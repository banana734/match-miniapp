<template>
  <view class="container">
    <view class="card">
      ...
      <text class="question-label">3. [多选] 满意点（本次课程中，学生表现好的地方）</text>
...
// 引入导师反馈页专属的选项常量（满意点/客观困难/主观困难）与通用文案常量
import {
  mentorDailyObjectiveUnsatisfiedOptions,
  mentorDailySatisfactionOptions,
  mentorDailySubjectiveUnsatisfiedOptions,
...
const satisfactionOptions = mentorDailySatisfactionOptions
const objectiveUnsatisfiedOptions = mentorDailyObjectiveUnsatisfiedOptions
const subjectiveUnsatisfiedOptions = mentorDailySubjectiveUnsatisfiedOptions
